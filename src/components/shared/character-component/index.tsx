    ...
    <div className="p-4 rounded-box bg-base-300 grid grid-cols-3 justify-between gap-2 text-base-content max-h-[260px] h-[260px]">
      <div className="flex flex-col gap-1 col-span-1">
        ...
        <div className="grid grid-cols-3 justify-center mt-2 gap-1 items-center grid-">
          <button className="dy-btn dy-btn-sm dy-btn-info px-1" onClick={(e) => { e.preventDefault(); openProfilePopup() }}><Info size={16} /></button>
          <button className="dy-btn dy-btn-sm dy-btn-info px-1" onClick={(e) => { e.preventDefault(); changeCharacterID() }}><MessageCircle size={16} /></button>
          <button className="dy-btn dy-btn-sm dy-btn-info px-1" onClick={(e) => { e.preventDefault(); handleConstructExport() }}><Download size={16} /></button>
        </div>
      </div>
